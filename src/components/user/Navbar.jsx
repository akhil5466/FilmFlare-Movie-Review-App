...
export default function Navbar() {
  ...
  return (
    <div className="dark:bg-secondary bg-white shadow-sm dark:shadow-gray-700 shadow-gray-200 p-1 rounded sm:text-2xl text-lg">

      <Container className="p-2">
        <div className="flex justify-between items-center">
          <Link to="/">
            <img src="./logo.jpg" alt="" className="sm:h-10 h-8" />
          </Link>
